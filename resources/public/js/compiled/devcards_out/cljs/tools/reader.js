...
var G__30351 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__30351;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__30352 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30352,ch);
...
if(("\\" === ch__$1)){
var ch_30353__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_30353__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_30353__$2);
} else {
}

var G__30354 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__30354;
continue;
}
}
...
var vec__30362 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30362,(0),null);
var start_column = cljs.core.nth.call(null,vec__30362,(1),null);
...
var G__30365 = cljs.core.conj_BANG_.call(null,a,form);
a = G__30365;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__30366 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__30367 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__30367;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__30366;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__30368 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30368,(0),null);
var start_column = cljs.core.nth.call(null,vec__30368,(1),null);
...
var vec__30371 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30371,(0),null);
var end_column = cljs.core.nth.call(null,vec__30371,(1),null);
...
var vec__30380 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30380,(0),null);
var start_column = cljs.core.nth.call(null,vec__30380,(1),null);
...
var vec__30383 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30383,(0),null);
var end_column = cljs.core.nth.call(null,vec__30383,(1),null);
...
var sb = (function (){var G__30386 = (new goog.string.StringBuffer());
G__30386.append(initch);
...
var G__30388 = (function (){var G__30387 = sb;
G__30387.append(ch);

return G__30387;
})();
var G__30389 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__30388;
ch = G__30389;
continue;
}
...
switch (G__30392) {
case "\\":
var G__30396 = (function (){var G__30393 = sb;
G__30393.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__30398 = (function (){var G__30394 = sb;
G__30394.append(ch);

return G__30394;
})();
var G__30399 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30398;
ch = G__30399;
continue;
...
var vec__30403 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30403,(0),null);
var column = cljs.core.nth.call(null,vec__30403,(1),null);
...
var vec__30408 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30408,(0),null);
var column = cljs.core.nth.call(null,vec__30408,(1),null);
...
var vec__30413 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30413,(0),null);
var column = cljs.core.nth.call(null,vec__30413,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__30418 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30418,(0),null);
var start_column = cljs.core.nth.call(null,vec__30418,(1),null);
...
var vec__30421 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30421,(0),null);
var end_column = cljs.core.nth.call(null,vec__30421,(1),null);
...
var G__30424 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__30424,true,null,opts,pending_forms);
...
var G__30425 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__30425)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__30425)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__30425)){
...
var _STAR_suppress_read_STAR__orig_val__30426 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__30427 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__30427;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__30426;
}});
...
var G__30428 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__30428,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__30428,rdr,first_line);
...
var G__30432 = matched;
var G__30433 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__30432;
finished = G__30433;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__30434 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__30435 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__30435;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__30434;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__30436 = cljs.tools.reader.arg_env;
var arg_env_temp_val__30437 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__30437;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__30438 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30438,"(");
...
var G__30439 = (i + (1));
var G__30440 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__30436;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__30441 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__30441);
...
var G__30444 = cljs.core.next.call(null,s);
var G__30445 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__30444;
key_vals = G__30445;
continue;
} else {
...
var gensym_env_orig_val__30449 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__30450 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__30450;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__30449;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__30451 = token;
var G__30451__$1 = (((G__30451 == null))?null:cljs.core.subs.call(null,G__30451,(1)));
var G__30451__$2 = (((G__30451__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30451__$1));
var G__30451__$3 = (((G__30451__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30451__$2));
var G__30451__$4 = (((G__30451__$3 == null))?null:cljs.core.symbol.call(null,G__30451__$3));
if((G__30451__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__30451__$4);
}
})():(function (){var G__30452 = token;
var G__30452__$1 = (((G__30452 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30452));
if((G__30452__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30452__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__30463,reader){
var map__30464 = p__30463;
var map__30464__$1 = (((((!((map__30464 == null))))?(((((map__30464.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30464.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__30464):map__30464);
var opts = map__30464__$1;
var eof = cljs.core.get.call(null,map__30464__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq30470){
var G__30471 = cljs.core.first.call(null,seq30470);
var seq30470__$1 = cljs.core.next.call(null,seq30470);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30471,seq30470__$1);
});


//# sourceMappingURL=reader.js.map?rel=1551004820992

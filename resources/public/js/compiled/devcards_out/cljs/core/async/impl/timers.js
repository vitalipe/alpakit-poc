...
var i_25020 = (self__.level + (1));
while(true){
if((i_25020 <= (new_level + (1)))){
(update[i_25020] = self__.header);

var G__25021 = (i_25020 + (1));
i_25020 = G__25021;
continue;
} else {
}
...
var i_25022 = (0);
while(true){
if((i_25022 <= self__.level)){
var links_25023 = (update[i_25022]).forward;
if((x__$1 === (((i_25022 < links_25023.length))?(links_25023[i_25022]):null))){
(links_25023[i_25022] = (x__$1.forward[i_25022]));

var G__25024 = (i_25022 + (1));
i_25022 = G__25024;
continue;
} else {
...
if((!((nx == null)))){
var G__25027 = nx;
var G__25028 = (level__$1 - (1));
x = G__25027;
level__$1 = G__25028;
continue;
} else {
var G__25029 = x;
var G__25030 = (level__$1 - (1));
x = G__25029;
level__$1 = G__25030;
continue;
}
...
//# sourceMappingURL=timers.js.map?rel=1551004818356

...
var G__29473 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__29473,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__29473;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq29475){
...
var line = cljs.core.get.call(null,map__29482__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__29482__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__29482,map__29482__$1,file,line,column){
return (function (p1__29481_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__29481_SHARP_));
});})(map__29482,map__29482__$1,file,line,column))
...
var temp__5720__auto___29484 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___29484)){
var message_29485 = temp__5720__auto___29484;
cljs.core.println.call(null,message_29485);
} else {
}
...
var temp__5720__auto___29486 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___29486)){
var message_29487 = temp__5720__auto___29486;
cljs.core.println.call(null,message_29487);
} else {
}
...
var output_dir__$1 = (function (){var G__29488 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__29488,"/"].join('');
} else {
return G__29488;
}
})();
...
var G__29490 = exception.stack;
var G__29490__$1 = (((G__29490 == null))?null:clojure.string.split_lines.call(null,G__29490));
var G__29490__$2 = (((G__29490__$1 == null))?null:cljs.core.get.call(null,G__29490__$1,depth));
if((G__29490__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__29490__$2);
}
} else {
...
var vec__29491 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__29491,(0),null);
var column = cljs.core.nth.call(null,vec__29491,(1),null);
var vec__29494 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__29494,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__29494,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__29494,(2),null);
...
var m__$1 = (function (){var G__29497 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__29501 = (function (){var G__29500 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__29500);
} else {
return G__29500;
}
})();
...
return cljs.core.vary_meta.call(null,G__29502,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__29506 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__29506,(0),null);
var types = vec__29506;
...
return cljs.core.map.call(null,(function (p__29509){
var vec__29510 = p__29509;
var ns = cljs.core.nth.call(null,vec__29510,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__29510,(1),null);
return ((function (vec__29510,ns,vars__$1){
return (function (){
...
var G__29513 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1){
return (function (){
var seq__29514 = cljs.core.seq.call(null,vars__$1);
var chunk__29515 = null;
var count__29516 = (0);
var i__29517 = (0);
while(true){
if((i__29517 < count__29516)){
var v = cljs.core._nth.call(null,chunk__29515,i__29517);
var temp__5720__auto___29519 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___29519)){
var t_29520 = temp__5720__auto___29519;
each_fixture_fn.call(null,((function (seq__29514,chunk__29515,count__29516,i__29517,t_29520,temp__5720__auto___29519,v,each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29520)));
});})(seq__29514,chunk__29515,count__29516,i__29517,t_29520,temp__5720__auto___29519,v,each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1))
);
} else {
}


var G__29521 = seq__29514;
var G__29522 = chunk__29515;
var G__29523 = count__29516;
var G__29524 = (i__29517 + (1));
seq__29514 = G__29521;
chunk__29515 = G__29522;
count__29516 = G__29523;
i__29517 = G__29524;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__29514);
if(temp__5720__auto__){
var seq__29514__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__29514__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__29514__$1);
var G__29525 = cljs.core.chunk_rest.call(null,seq__29514__$1);
var G__29526 = c__4550__auto__;
var G__29527 = cljs.core.count.call(null,c__4550__auto__);
var G__29528 = (0);
seq__29514 = G__29525;
chunk__29515 = G__29526;
count__29516 = G__29527;
i__29517 = G__29528;
continue;
} else {
var v = cljs.core.first.call(null,seq__29514__$1);
var temp__5720__auto___29529__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___29529__$1)){
var t_29530 = temp__5720__auto___29529__$1;
each_fixture_fn.call(null,((function (seq__29514,chunk__29515,count__29516,i__29517,t_29530,temp__5720__auto___29529__$1,v,seq__29514__$1,temp__5720__auto__,each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29530)));
});})(seq__29514,chunk__29515,count__29516,i__29517,t_29530,temp__5720__auto___29529__$1,v,seq__29514__$1,temp__5720__auto__,each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1))
);
} else {
}


var G__29531 = cljs.core.next.call(null,seq__29514__$1);
var G__29532 = null;
var G__29533 = (0);
var G__29534 = (0);
seq__29514 = G__29531;
chunk__29515 = G__29532;
count__29516 = G__29533;
i__29517 = G__29534;
continue;
}
} else {
...
});})(each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1))
);
});})(each_fixture_fn,G__29513,G__29513__$1,env,once_fixtures,each_fixtures,vec__29510,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29513__$1)].join('')));

}
})());
});
;})(vec__29510,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1551004820091
